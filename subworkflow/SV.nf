...
//                SV_data_organization(SV_annotation.out.annotation_vcf, assembly, run, SV, severity_table)
	...
	//The following steps are deactivated for the test version as there is no container for Expansion_hunter V5 and that the header generated by V4 do not work with bcftools annotate

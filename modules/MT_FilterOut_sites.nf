...
process MT_FilterOut_sites {
	...
	if [ -a $params.outdir_ind/${assembly}/*/${run}/MT/Sample/\${sample_name}_MT_merged_filtered_trimmed_filtered_sites.vcf.gz ]; then
		filtered_sites_vcf=\$(find $params.outdir_ind/${assembly}/*/${run}/MT/Sample/ -name ${MT_trimmed.simpleName}_filtered_sites.vcf.gz)
		filtered_sites_index=\$(find $params.outdir_ind/${assembly}/*/${run}/MT/Sample/ -name ${MT_trimmed.simpleName}_filtered_sites.vcf.gz.tbi)
